...
public class ErrorDialogConfig {
    ...
    final event.util.ExceptionToResourceMapping mapping;
    ...
    public ErrorDialogConfig(Resources resources, int defaultTitleId, int defaultMsgId) {
        ...
        mapping = new event.util.ExceptionToResourceMapping();
    }
    ...
    public int getMessageIdForThrowable(final Throwable throwable) {
        ...
        if (resId != null) {
            ...
            LogUtil.d(EventBus.TAG, "No specific message ressource ID found for " + throwable);
