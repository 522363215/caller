...
//  private static final PorterDuffXfermode DST_IN_PORTER_DUFF_XFERMODE = new PorterDuffXfermode(PorterDuff.Mode.DST_IN);
  ...
  // enum specifying the shape of the highlight mask applied to the contained viewSelected
  ...
  private static class Mask {
    ...
    public int[] getGradientColors() {
      switch (shape) {
        default:
        case LINEAR:
          return new int[]{Color.TRANSPARENT, 0x52FFFFFF, 0x52FFFFFF, Color.TRANSPARENT};
        case RADIAL:
  ...
  /**
   * Get the alpha currently used to render the base viewSelected i.e. the unhighlighted viewSelected over which the highlight is drawn.
   *
   * @return Alpha (opacity) of the base viewSelected
   */
  ...
  /**
   * Set the alpha to be used to render the base viewSelected i.e. the unhighlighted viewSelected over which the highlight is drawn.
   *
   * @param alpha Alpha (opacity) of the base viewSelected
   */
