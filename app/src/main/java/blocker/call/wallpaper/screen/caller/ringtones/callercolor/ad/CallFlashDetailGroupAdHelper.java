...
public class CallFlashDetailGroupAdHelper {
    ...
    private static final String TAG = "CallFlashDetailGroupAdHelper-PreloadAdvertisement";
    private static CallFlashDetailGroupAdHelper sInstance;
    ...
    public static CallFlashDetailGroupAdHelper getInstance() {
        if (sInstance == null) {
            synchronized (CallFlashDetailGroupAdHelper.class) {
                sInstance = new CallFlashDetailGroupAdHelper();
                return sInstance;
            }
        }
        return sInstance;
    ...
    private CallFlashDetailGroupAdHelper() {
    ...
    public void showGroupAd(final boolean isResetShowAd, final View adView, final String key, final boolean isBanner, final int admobType, final int admobAdxType, final boolean isLooperShow) {
        try {
            if (isResetShowAd) {
            ...
            if (adIdInfo == null) {
                Async.scheduleTaskOnUiThread(nextShowDelay, mLooperShowAdRunnable = new Runnable() {
                    @Override
                    public void run() {
                        showGroupAd(false, adView, key, isBanner, admobType, admobAdxType, isLooperShow);
                    }
                });
                return;
            }
...
//                loadAd(adIdInfo.adId, key, isBanner, adIdInfo.adShowPriority, adTypeInfo);
                    ...
                    mIsShowGroupAd = true;
                    preloadAdvertisement.isAdaptiveSize(true);
                    preloadAdvertisement.showAd(adView);
                    nextShowDelay = SHOW_AD_PERIOD;
                }

                if (isLooperShow || nextShowDelay == 0) {
                    Async.scheduleTaskOnUiThread(nextShowDelay, mLooperShowAdRunnable = new Runnable() {
                        @Override
                        public void run() {
                            try {
    ...
    private void setAdShowPriority(String key) {
        ...
        LogUtil.d(TAG, "setAdShowPrioadPriorityrity :" + String.valueOf(adPriority));
...
//            LogUtil.d(TAG, "setAdShowPriority adtype:" + adIdInfo.adType + ",mAdShowPriority:" + adIdInfo.adShowPriority + ",adid:" + adIdInfo.adId);
//        }
    }
        ...
        for (String ad : adPriority) {
            if (AdvertisementSwitcher.AD_FACEBOOK.equals(ad)) {
                if (PreloadAdvertisement.AdShowPriority.HIGH.equals(adShowPriority)) {
                    String fbAdHighId = CallerAdManager.getBigGroupIdByKey(CallerAdManager.KEY_FLASH_DOWN_GROUP_FACEBOOK_HIGH);
                    ...
                    String fbAdMediumId = CallerAdManager.getBigGroupIdByKey(CallerAdManager.KEY_FLASH_DOWN_GROUP_FACEBOOK_MEDIUM);
                    ...
                    String fbAdNormalId = CallerAdManager.getBigGroupIdByKey(CallerAdManager.KEY_FLASH_DOWN_GROUP_FACEBOOK_NORMAL);
                ...
                if (PreloadAdvertisement.AdShowPriority.HIGH.equals(adShowPriority)) {
                    String admobAdHighId = CallerAdManager.getBigGroupIdByKey(CallerAdManager.KEY_FLASH_DOWN_GROUP_ADMOB_HIGH);
                    ...
                    String admobAdMediumId = CallerAdManager.getBigGroupIdByKey(CallerAdManager.KEY_FLASH_DOWN_GROUP_ADMOB_MEDIUM);
                    ...
                    String admobAdNormalId = CallerAdManager.getBigGroupIdByKey(CallerAdManager.KEY_FLASH_DOWN_GROUP_ADMOB_NORMAL);
                ...
                if (PreloadAdvertisement.AdShowPriority.HIGH.equals(adShowPriority)) {
                    String admobAdxAdHighId = CallerAdManager.getBigGroupIdByKey(CallerAdManager.KEY_FLASH_DOWN_GROUP_ADMOB_ADX_HIGH);
                    ...
                    String admobAdxAdMediumId = CallerAdManager.getBigGroupIdByKey(CallerAdManager.KEY_FLASH_DOWN_GROUP_ADMOB_ADX_MEDIUM);
                    ...
                    String admobAdxAdNormalId = CallerAdManager.getBigGroupIdByKey(CallerAdManager.KEY_FLASH_DOWN_GROUP_ADMOB_ADX_NORMAL);
                ...
                if (preloadAdvertisement == null || (!preloadAdvertisement.isValid(true) && !preloadAdvertisement.isLoading())) {
                    ...
                    if (preloadAdvertisement.isValid(true)) {
                        ...
                        if (isShowGroupAd && !mIsShowGroupAd) {
                            mIsShowGroupAd = true;
                            EventBus.getDefault().post(new EventCallFlashDetailGroupAdShow());
                        }
                    }
                }
            } else {
